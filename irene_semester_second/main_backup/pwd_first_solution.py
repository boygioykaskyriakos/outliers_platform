...
class AnalyticsFirstSolution:
    ...
    def frequency_histogram_numpy(self, field: str, sample_array: list) -> (dict, list):
        """
    ...
    def health_analyzer_numpy(self, source_field: str, specific_value: float, target_field: str) -> (dict, list):
        """
...
def run_first_solution(rate_specs, field, field_value, target_field, path_to_save, n=1000):
    ...
    array_measurements_first_solution = my_health_care_numpy(my_rate_specs, n)
    # initialize class
...
def benchmark_first_solution(rate_specs, field, field_value, target_field):
    ...
    for idx, n in enumerate(n_samples):
        ...
        # generate records
        my_array_measurements_benchmark = my_health_care_numpy(my_rate_specs, n)
        # initialize class
